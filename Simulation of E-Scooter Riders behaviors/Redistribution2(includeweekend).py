...
# fl = open('MaxCapacity.csv', 'w')

# writer = csv.writer(fl)
# writer.writerow(['MRT', 'Kiosk1', 'Kiosk2', 'Kiosk3', 'Kiosk4', 'Kiosk5', 'Kiosk6', 'Kiosk7', 'Kiosk8', 'Kiosk9', 'Kiosk10', 'Kiosk11', 'Kiosk12', 'Kiosk13', 'Kiosk14', 'Kiosk15']) #if needed
# for values in ar:
